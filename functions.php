...
function eindland_theme_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'lllocalhost')) {
    ...
    // wp_enqueue_script('eindland_main_script', get_theme_file_uri('/bundled-assets/scripts.2176a3134e5f79934998.js'), NULL, '1.0', true);
    wp_enqueue_style('eindland_main_styles', get_theme_file_uri('/bundled-assets/styles.2176a3134e5f79934998.css'));
  }

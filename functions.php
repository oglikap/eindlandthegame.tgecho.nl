...
function eindland_theme_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'localhost')) {
    ...
    wp_enqueue_script('eindland_main_script', get_theme_file_uri('/bundled-assets/scripts.6cff541881ee6c0d36d0.js'), NULL, '1.0', true);
    wp_enqueue_style('eindland_main_styles', get_theme_file_uri('/bundled-assets/styles.6cff541881ee6c0d36d0.css'));
  }
